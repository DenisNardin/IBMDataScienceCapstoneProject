...
def get_pie_chart(entered_site):
    ...
    successes=len(filtered_df[filtered_df["class"]==1])
    failures=len(filtered_df[filtered_df["class"]==0])
    fig=px.pie(values=[successes,failures],names=["Successes","Failures"],title=title)
    return fig
# TASK 4:
